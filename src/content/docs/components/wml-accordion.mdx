...
## Installation
```bash
npm install -s --verbose @windmillcode/angular-wml-accordion
```
...
{/* // TODO fix
## CSS Customization
<iframe  src="https://stackblitz.com/edit/stackblitz-starters-yysl6k?ctl=1&embed=1file=src%2Fmain.ts&theme=dark"></iframe> */}
