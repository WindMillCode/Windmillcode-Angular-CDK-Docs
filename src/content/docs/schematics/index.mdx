...
```bash
npm install -d @windmillcode/angular-wml-schematics
```
...
<iframe src="https://stackblitz.com/edit/stackblitz-starters-pk1cgq?embed=1&file=tsconfig.json&theme=dark"></iframe>
