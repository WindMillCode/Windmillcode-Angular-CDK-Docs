...
```bash
npm install -d @windmillcode/angular-wml-mobile-nav @windmillcode/angular-wml-infinite-dropdown
```
...
<iframe src="https://stackblitz.com/edit/stackblitz-starters-bmd9s5?embed=1&file=src%2Fmain.ts&hideExplorer=1&theme=dark"></iframe>


### Adding A Logo Header
* This is the same as adding custom components
<iframe src="https://stackblitz.com/edit/stackblitz-starters-9fsvzy?embed=1&file=src%2Fmain.ts&hideExplorer=1&theme=dark"></iframe>
