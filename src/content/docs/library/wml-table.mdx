...
```bash
npm install -d @windmillcode/angular-wml-table
```
...
<iframe src="https://stackblitz.com/edit/stackblitz-starters-jj1djc?embed=1&file=src%2Fmain.ts&hideExplorer=1&theme=dark"></iframe>
