...
```bash
npm install -d @windmillcode/angular-wml-toggle
```
...
<iframe src="https://stackblitz.com/edit/stackblitz-starters-cmgmdk?embed=1&file=src%2Fmain.ts&hideExplorer=1&theme=dark"></iframe>


#### Programtic Toggle
<iframe src="https://stackblitz.com/edit/stackblitz-starters-khfnfw?embed=1&file=src%2Fmain.ts&hideExplorer=1&theme=dark"></iframe>

#### Reactive Forms

<iframe src="https://stackblitz.com/edit/stackblitz-starters-fk265u?embed=1&file=src%2Fmain.ts&hideExplorer=1&theme=dark"></iframe>
