import { A as AstroError, L as LiveContentConfigError, a as AstroUserError, e as objectType, k as dateType, n as numberType, G as arrayType, s as stringType, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, K as escape$1, v as unescapeHTML, b as renderTemplate, M as renderUniqueStylesheet, N as renderScriptElement, O as createHeadAndContent, r as renderComponent } from './astro/server_DEq4NUVT.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DoSQJcY9.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_ZkJxiC6y.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DnYJQVPk.mjs');
